...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    var AuthService = /*#__PURE__*/function () {
      ...
      _createClass(AuthService, [{
        ...
        value: function registerUser(user) {
          var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_1__["Headers"](); //ф-ция отправляет объект по url адресу

          headers.append('Content-Type', 'application/json');
          return this.http.post('account/reg', user, {
            headers: headers
          }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (respone) {
            return respone.json();
          }));
  ...
  function srcAppHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 5,
      consts: [[1, "d-flex", "flex-column", "flex-md-row", "align-items-center", "p-3", "px-md-4", "mb-3", "bg-white", "border-bottom", "shadow-sm"], [1, "my-0", "mr-md-auto", "font-weight-normal"], [1, "my-2", "my-md-0", "mr-md-3"], [1, "p-2", "text-dark", 3, "routerLink"], ["class", "btn btn-outline-primary mr-3", 3, "routerLink", 4, "ngIf"], ["class", "btn btn-outline-primary", 3, "routerLink", 4, "ngIf"], [1, "btn", "btn-outline-primary", "mr-3", 3, "routerLink"], [1, "btn", "btn-outline-primary", 3, "routerLink"]],
  ...
  function srcAppIsLoggedGuardTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! @angular/router */
    "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js"); //для использования сервиса
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\dom\Desktop\Node-js\front-end-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
